...
def load_model(checkpoint_path, num_classes=80, num_boxes=10):
...
def main():
    # Paths
    checkpoint_path = "lightning_logs/version_209/checkpoints/yolo-epoch=10-avg_train_loss=1.82.ckpt"  # Path to the trained weights
