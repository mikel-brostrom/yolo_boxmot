...
def bbox_data():
    ...
    pred_bbox = torch.tensor([
        [[0.1, 0.1, 0.4, 0.4], [0.5, 0.5, 0.9, 0.9]],  # Predictions for batch 1
        [[0.2, 0.2, 0.5, 0.5], [0.6, 0.6, 0.8, 0.8]]   # Predictions for batch 2
    ])
    target_bbox = torch.tensor([
        [[0.1, 0.1, 0.4, 0.4], [0.5, 0.5, 0.9, 0.9]],  # Ground truth for batch 1
        [[0.2, 0.2, 0.5, 0.5], [0.0, 0.0, 0.0, 0.0]]   # Ground truth for batch 2, second box is invalid
    ])
...
def bbox_data_mismatched_1():
    ...
    pred_bbox = torch.tensor([
        [[0.1, 0.1, 0.4, 0.4], [0.5, 0.5, 0.9, 0.9]]  # Only 1 Prediction for batch 1
    ])
    target_bbox = torch.tensor([
...
def test_match_predictions_to_targets(bbox_data):
    pred_bbox, target_bbox = bbox_data
